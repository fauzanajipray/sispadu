...
class _HistoryPageState extends State<HistoryPage> {
  ...
  void initState() {
    ...
    _pagingController.addPageRequestListener((pageKey) {
      context.read<MyReportListBloc>().add(FetchEvent(pageKey));
    });
    context.read<MyReportListBloc>().stream.listen((event) {
  ...
  void _resetSearchTerm() {
    context.read<MyReportListBloc>().add(
  ...
  Widget _buildViews(BuildContext context) {
    return RefreshIndicator(
      ...
      child: BlocConsumer<MyReportListBloc, DataListState<Report>>(
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(formatDateTimeCustom(item.createdAt),
                                      style: const TextStyle(
                                        fontSize: 12,
                                        fontWeight: FontWeight.w400,
                                      )),
