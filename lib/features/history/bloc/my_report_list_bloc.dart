...
class MyReportListBloc extends Bloc<DataListingEvent, DataListState<Report>> {
  MyReportListBloc(this._repository) : super(const DataListState()) {
  ...
  Future<DataListState<Report>> fetchListing(int pageKey,
    ...
    try {
      final response = await _repository.getMyReportList(pageKey, search, '');
